...
public class Route implements RouteParts {
	...
	public boolean equals(Object obj) {
		...
		if (this.routeParts != other.routeParts || !this.vehicle.equals(other.vehicle))
			return false;
		return true;
	}
	...
	public String toString() {
		return new String("Route from " + getFirstPart() + " to " + getLastPart() + ", estimated time for route: "

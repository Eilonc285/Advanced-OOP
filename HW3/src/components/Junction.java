...
public class Junction extends utilities.Point implements RouteParts {
	...
	public boolean equals(Object other) {
		...
		if (this.enteringRoads.equals(otherJunc.enteringRoads) && this.exitingRoads.equals(otherJunc.exitingRoads)
	...
	/**
	 * Checks if there are exiting roads for given vehicle and if the vehicle is
	 * first in the waiting list of its road
	 * 
	 * @param vehicle
	 * @return
	 */
